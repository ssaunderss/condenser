defmodule CondenserWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CondenserWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CondenserWeb.Gettext, "errors", msg, opts)
    end
  end
